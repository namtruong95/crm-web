...
@Component({
  selector: 'app-report-customer-care-filter',
  templateUrl: './report-customer-care-filter.component.html',
  styleUrls: ['./report-customer-care-filter.component.scss'],
})
export class ReportCustomerCareFilterComponent implements OnInit {
  @Output()
